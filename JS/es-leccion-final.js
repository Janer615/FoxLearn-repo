const questions4 = [
  { text: "El __ corre rápido por el jardín porque quiere jugar.", options: ["gato", "perro", "sol", "árbol"], correct: 1 },
  { text: "El cielo está muy __ hoy.", options: ["azul", "rojo", "frío", "alto"], correct: 0 },
  { text: "Selecciona el sinónimo de 'feliz' que completa la frase: Lucas está muy __ porque recibió un regalo.", options: ["triste", "contento", "cansado", "aburrido"], correct: 1 },
  { text: "El conejo __ rápidamente hacia su madriguera.", options: ["salta", "duerme", "llora", "canta"], correct: 0 },
  { text: "Selecciona el antónimo de 'pequeño' para completar: El elefante es muy __.", options: ["grande", "chiquito", "diminuto", "bajo"], correct: 0 },
  { text: "María y Juan van a la biblioteca a __ libros interesantes.", options: ["leer", "dormir", "saltar", "cantar"], correct: 0 },
  { text: "Completa la historia: El sol se __ detrás de las montañas y la luna empieza a brillar.", options: ["esconde", "canta", "corre", "llora"], correct: 0 },
  { text: "El pastel está muy __ y todos quieren probarlo.", options: ["dulce", "amargo", "frío", "rápido"], correct: 0 }
];
