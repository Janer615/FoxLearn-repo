const questions3 = [
  { text: "Lee: 'El gato negro duerme en la silla.' ¿Dónde duerme el gato?", options: ["En la mesa", "En la silla", "En la cama", "En el suelo"], correct: 1 },
  { text: "Lee: 'Luis juega con su pelota en el parque.' ¿Qué hace Luis?", options: ["Corre en la escuela", "Juega en casa", "Juega en el parque", "Duerme en la cama"], correct: 2 },
  { text: "Lee: 'María come manzanas y naranjas.' ¿Qué come María?", options: ["Solo manzanas", "Solo naranjas", "Manzanas y naranjas", "Plátanos"], correct: 2 },
  { text: "Lee: 'El perro ladra fuerte por la noche.' ¿Cuándo ladra el perro?", options: ["Por la mañana", "Por la tarde", "Por la noche", "Todo el día"], correct: 2 },
  { text: "Lee: 'El sol brilla en el cielo azul.' ¿De qué color es el cielo?", options: ["Rojo", "Amarillo", "Azul", "Verde"], correct: 2 },
  { text: "Lee: 'Ana y Pedro van a la escuela juntos.' ¿Quiénes van a la escuela?", options: ["Ana y Pedro", "Ana y María", "Pedro y Luis", "Luis y Ana"], correct: 0 }
];
