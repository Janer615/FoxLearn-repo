const questions2 = [
    {
      text: "Selecciona el sinónimo de 'feliz':",
      options: ["Contento", "Triste", "Enojado", "Aburrido"],
      correct: 0
    },
    {
      text: "Selecciona el antónimo de 'grande':",
      options: ["Pequeño", "Enorme", "Alto", "Ancho"],
      correct: 0
    },
    {
      text: "Selecciona el sinónimo de 'rápido':",
      options: ["Veloz", "Lento", "Pesado", "Tranquilo"],
      correct: 0
    },
    {
      text: "Selecciona el antónimo de 'caliente':",
      options: ["Frío", "Tibio", "Húmedo", "Seco"],
      correct: 0
    },
    {
      text: "Selecciona el sinónimo de 'bonito':",
      options: ["Hermoso", "Feo", "Sucio", "Grande"],
      correct: 0
    },
    {
      text: "Selecciona el antónimo de 'alto':",
      options: ["Bajo", "Gigante", "Mediano", "Largo"],
      correct: 0
    }
  ];
